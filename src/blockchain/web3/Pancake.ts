...
class PancakeWrapper {
  ...
  pancake: any
    ...
    constructor(signer: any) {
        this.pancake = new ethers.Contract(pancakeAddress, JSON.stringify(abi), signer)
    }
    
    getAmountsOut(_amountIn: number, _tokenIn: String, _tokenOut: String, decimal: number) {
        if (_amountIn == 0) {
            return 0;
        }
        ...
        // same length as path
        amountOutMins = this.pancake.getAmountsOut(
